...
[![CodeChef](https://img.shields.io/badge/CodeChef-5B4638?style=for-the-badge&logo=codechef&logoColor=white)](https://www.codechef.com/users/pbisht16)
...
|:--:|:--|:--|:--|:--:|
| 1 | **CivicLens** | AI-driven civic issue detection system — classifies images (potholes, garbage, waterlogging) using a custom-trained CNN with real-time inference & REST API | ![Python](https://img.shields.io/badge/Python-555?style=flat-square) ![Flask](https://img.shields.io/badge/Flask-555?style=flat-square) ![TensorFlow](https://img.shields.io/badge/TensorFlow-555?style=flat-square) ![CNN](https://img.shields.io/badge/CNN_Model-555?style=flat-square) | [View →](https://github.com/poojabisht10/civiclens) |
| 2 | **Aptly** | AI-powered resume & cover letter optimizer — ATS scoring, keyword relevance checks, and Gemini-driven analysis tailored to job descriptions | ![React](https://img.shields.io/badge/React-555?style=flat-square) ![TypeScript](https://img.shields.io/badge/TypeScript-555?style=flat-square) ![Gemini API](https://img.shields.io/badge/Gemini_API-555?style=flat-square) ![Tailwind](https://img.shields.io/badge/Tailwind-555?style=flat-square) | [View →](https://github.com/poojabisht10/aptly) |
| 3 | **SmartShelf** | Real-time inventory monitoring system — benchmarked YOLOv8, EfficientNet, MobileNetV2 & ResNet; optimized for detection accuracy and inference speed | ![Python](https://img.shields.io/badge/Python-555?style=flat-square) ![PyTorch](https://img.shields.io/badge/PyTorch-555?style=flat-square) ![YOLOv8](https://img.shields.io/badge/YOLOv8-555?style=flat-square) ![OpenCV](https://img.shields.io/badge/OpenCV-555?style=flat-square) | [View →](https://github.com/poojabisht10/smartshelf) |
| 4 | **TOPSIS** | Multi-criteria decision making tool implementing the TOPSIS algorithm for ranking alternatives across weighted criteria | ![Python](https://img.shields.io/badge/Python-555?style=flat-square) ![NumPy](https://img.shields.io/badge/NumPy-555?style=flat-square) ![Pandas](https://img.shields.io/badge/Pandas-555?style=flat-square) ![CLI Tool](https://img.shields.io/badge/CLI_Tool-555?style=flat-square) | [View →](https://github.com/poojabisht10) |
